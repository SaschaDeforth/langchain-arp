...
```bash
pip install langchain-arp
```

With optional LangChain integration:
```bash
pip install langchain-arp[langchain]
```

With JSON Schema validation:
```bash
pip install langchain-arp[all]
```
...
**Spec:** [arp-protocol.org](https://arp-protocol.org) | **Schema:** [v1.json](https://arp-protocol.org/schema/v1.json)
